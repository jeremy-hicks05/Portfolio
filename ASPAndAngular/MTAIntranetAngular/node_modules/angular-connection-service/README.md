# Internet Connection Monitoring Service (Angular v13)
...
```
npm install angular-connection-service --save
```
...
[MIT License](https://github.com/Ryadel/angular-connection-service/blob/master/LICENSE) © Balram Chavan
